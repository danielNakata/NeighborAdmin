  ...
  if(isset($params)){
    ...
    if(isset($connex)){
      ...
      if(isset($resultado1)){
        ...
        if($existe == 1){
          $sql3 = 'update dbneigh_admin.tcomplaints set idusrchk = '.$jsonParams->idusrchk
          ...
          if($filasact > 0){
            $salida = '{"res": 1, "msg":"QUEJA REVISADA ACTUALIZADO ('.$jsonParams->idusr.')"}';
          }else{
            $salida = '{"res": 0, "msg":"NO SE PUDO REVISAR LA QUEJA"}';
          }
        }
      }
    }
